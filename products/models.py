...
class Product(models.Model):
    ...
    description_en = models.TextField(max_length=300, verbose_name=_("descripción en inglés"), blank=True, null=True)
    description_fr = models.TextField(max_length=300, verbose_name=_("descripción en francés"), blank=True, null=True)
    ...
    photo = models.ImageField(upload_to="logos", null=True, blank=True, verbose_name=_("Foto"))
